...
#define OPENMS_GET_TEST_DATA_PATH(filename) (std::string("C:/Users/piyus/OpenMS/src/tests/class_tests/openms/data/") + filename).c_str()
#define OPENMS_GET_TEST_DATA_PATH_MESSAGE(prefix,filename,suffix) (prefix + std::string("C:/Users/piyus/OpenMS/src/tests/class_tests/openms/data/") + filename + suffix).c_str()
